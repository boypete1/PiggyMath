...
//        Show Time
    ...
    private void showView(int indexInt) {
        ...
        Button choice3Button = (Button) getView().findViewById(R.id.btnChoice3);
        Button choice4Button = (Button) getView().findViewById(R.id.btnChoice4);
    ...
    private void checkScore(int timesAnInt, int answerInt) {
        TextView textView = (TextView) getView().findViewById(R.id.txtShowscore);
        ImageView imageView = (ImageView) getView().findViewById(R.id.imvEat);
